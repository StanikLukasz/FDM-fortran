...
http://home.agh.edu.pl/~macwozni/fort/projekt1.pdf
...
Aby skompilowac program z domyslnymi ustawieniami (real kind = 8) nalezy wykorzystac komende `make main`, a nastepnie wywo³ac program piszac `FDM N`, gdzie *N* oznacza gêstosc podzialu siatki MRS. Dla poszczegolnych *"kind'ow"* mozna uzyc komend odpowiednio 
`make kind4`,
`make kind8`,
`make kind16`
...
Ponizej przedstawiam wykresy zaleznosci bledu obliczen od wyboru gestosci siatki podzialu dziedziny problemu (w zakresie [10, 2560] o skali logarytmicznej o podstawie 2) dla trzech precyzji zmiennych uzytych w obliczeniach.
